...
public class MostrarLibros extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MostrarLibros</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MostrarLibros at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            response.setContentType("text/html;charset=UTF-8");
            DAO dao = new DAO();
            listaLibros = (ArrayList<String>) dao.leerLibros(20112449);
