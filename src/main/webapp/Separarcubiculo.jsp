        ...
        <header>
            <div class="container ">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="intro-text">
                            ...
                            <span class="name">Cubículos</span>
                            <hr class="star-light">
                ...
                <form method="post" action="ServletAsignar">
                    ...
                    <div class="form-group row">
                        <label  class="col-xs-2 col-form-label">Hora Inicio:</label>
                        <div class="col-xs-10">
                            <input class="form-control" type="time" value="13:45:00" id="hora_ini">
                        </div>
                    </div>

                    <div class="form-group">
                        <button class="btn btn-primary btn-lg btn-block">Reservar cubículo</button>
                    </div>
